...
2. Open main.py in an editor like Thonny and set the value of bpm to the beats per minute you just measured.
3. Save the file and reset your microcontroller.
